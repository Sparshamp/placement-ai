...
from experiments.selectors import (  # noqa: E402
    ...
    BKTOnlySelector,
    BKTEMAEpsilonGreedySelector,
    EMAOnlyFocusedSelector,
    BKTOnlyFocusedSelector,
    BKTEMAEpsilonGreedyFocusedSelector,
)
from experiments.simulators import SimpleAbilitySimulator, BKTGenerativeSimulator, IRTGenerativeSimulator  # noqa: E402
from experiments.runner import ExperimentConfig, run_experiment  # noqa: E402
...
ALGORITHM_REGISTRY = {
    ...
    "bkt": BKTOnlySelector,
    "bkt_ema_epsilon_greedy": BKTEMAEpsilonGreedySelector,
    # Concept-FOCUS variants: same tracker, but stay on one concept until
    # mastered/exhausted before moving to the next unlocked one, instead of
    # roaming the whole category one concept per question. See
    # experiments/selectors/mastery_based.py MasteryBasedSelector.focus_until_mastered.
    "ema_only_focused": EMAOnlyFocusedSelector,
    "bkt_focused": BKTOnlyFocusedSelector,
    "bkt_ema_epsilon_greedy_focused": BKTEMAEpsilonGreedyFocusedSelector,
    # "thompson_sampling": ...,  # future work
    # "irt_2pl": ...,            # future work (fit-only benchmark)
}
